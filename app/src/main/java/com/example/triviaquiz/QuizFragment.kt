...
import com.example.triviaquiz.api.RetrofitInstance
import com.example.triviaquiz.databinding.FragmentQuizBinding
...
//                    Toast.makeText(context,"Finish",Toast.LENGTH_LONG).show()
                    ...
                    if(mOptionList[mCurrentQuestion-1][mSelectedOption-1] == mAnswerList[mCurrentQuestion-1]){
                        mCorrectAnswer++;
                        mCurrentQuestion++;
                        answerView(mSelectedOption,R.drawable.correct_option_border)
                        ...
                        answerView(mCorrectOptionNumber,R.drawable.correct_option_border)
